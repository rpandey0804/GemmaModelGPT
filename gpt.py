...
st.set_page_config(page_title="🧠 Ask Open AI | LangChain", layout="centered")

# Header section with styling
st.markdown("""
    <h1 style='text-align: center; color: #4A90E2;'>🤖 Ask Anything with OpenAI</h1>
    <p style='text-align: center; font-size:18px;'>Built with LangChain, OpenAI & Streamlit</p>
...
Built with ❤️ by Rohit | Powered by LangChain, OPENAI & Streamlit
</p>
""", unsafe_allow_html=True)
